...
def find_arbitrage_sushiswap(token1_address, token2_address):
    try:
        ...
        with networks.parse_network_choice("avalanche:mainnet-fork:foundry") as provider:
            ...
            if traderjoe_price == 0 or sushiswap_price == 0:
                return "Unable to fetch prices. There might not be a liquidity pool for these tokens on one or both exchanges."
            ...
            if arbitrage_opportunity(traderjoe_rate, sushiswap_rate):
                ...
                return "No arbitrage opportunity found between these tokens on TraderJoe and SushiSwap."
